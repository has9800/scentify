      ...
      <div className="product-detail-container flex flex-col md:flex-row md:items-center">
        ...
        <div className="product-detail-desc w-full">
          ...
          <p className="text-xs">
            ...
            <span className="">${Math.round(price / 4)}/month</span> interest
            free using <span className="font-bold">AfterPay</span>
          </p>
          <div className="quantity mt-10">
            <h3 className="text-xl mr-1">Quantity</h3>
            <p className="flex flex-row items-center justify-center md:justify-start">
              <span
                className="minus light-brown-bg rounded-sm w-16 p-1 text-white hover:scale-95 hover:transition-all hover:cursor-pointer shadow-lg"
                onClick={decQty}
              >
              ...
              <span
                className="plus light-brown-bg rounded-sm w-16 p-1 text-white hover:scale-95 hover:transition-all hover:cursor-pointer shadow-lg"
                onClick={incQty}
              >
          ...
          <div className="buttons">
            <button
              type="button"
              className="add-to-cart mr-4"
              onClick={() => onAdd(product, qty)}
            >
              Add to cart
            </button>
            <button type="button" className="buy-now mr-4" onClick="">
              Buy now
            </button>
          </div>
        </div>
